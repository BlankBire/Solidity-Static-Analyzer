    ...
    try {
        ...
        while ((m = importRx.exec(content)) !== null) {
            ...
            if (!fs.existsSync(importAbs)) {
                ...
                pushFinding(line, col, col + Math.min(importPath.length + 7, 80), `Source '${importAbs}' not found: File import not resolved.`, "IMPORT_NOT_FOUND", vscode.DiagnosticSeverity.Error);
                continue;
            }
